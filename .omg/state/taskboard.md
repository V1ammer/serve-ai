...
| :--- | :--- | :--- | :--- | :--- | :--- |
| T01 | p0 | ready | Git Setup (Init, Remote, First Commit) | `omg-executor` | |
| T02 | p0 | ready | `uv` Project Initialization | `omg-executor` | T01 |
| T03 | p0 | blocked | Configure Dependencies (`llama-cpp-python`, `vllm`, `sglang`) | `omg-executor` | T02 |
| T04 | p1 | blocked | Implement Hardware Detection Logic | `omg-executor` | T03 |
| T05 | p1 | blocked | Implement Model Selection & GGUF Quant Mapping | `omg-executor` | T04 |
| T06 | p1 | blocked | Implement Engine Integration (CPU/APU limits) | `omg-executor` | T05 |
| T07 | p1 | blocked | Implement Iterative Execution & t/s Table Output | `omg-executor` | T06 |
